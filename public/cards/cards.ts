export const cards = {
  ...
  behueter: {
    ...
    verse:
      "Der HERR ist dein Hüter, der HERR ist dein Schatten zu deiner Rechten. Bei Tage wird dich die Sonne nicht stechen noch der Mond des Nachts.",
    translation: "Zürcher Bibel",
  ...
  fels: {
    ...
    verse:
      "Der HERR lebt. Gepriesen ist mein Fels, erhaben ist Gott, der Fels meines Heils.",
    translation: "Zürcher Bibel",
  ...
  feuer: {
    ...
    verse:
      "Der HERR aber ging vor ihnen her, am Tag in einer Wolkensäule, um sie den Weg zu führen, und bei Nacht in einer Feuersäule, um ihnen zu leuchten, so dass sie Tag und Nacht gehen konnten.",
    translation: "Zürcher Bibel",
  ...
  fluegel: {
    ...
    verse:
      "Sei mir gnädig, Gott, sei mir gnädig, denn bei dir suche ich Zuflucht. Im Schatten deiner Flügel suche ich Zuflucht, bis das Verderben vorüber ist.",
    translation: "Zürcher Bibel",
  ...
  henne: {
    ...
    verse:
      "Wie oft habe ich deine Kinder um mich sammeln wollen, wie eine Henne ihre Küken unter ihre Flügel sammelt, und ihr habt nicht gewollt.",
    translation: "Zürcher Bibel",
  ...
  loewe: {
    ...
    verse:
      "Denn ich bin wie ein Löwe für Efraim und wie ein junger Löwe für das Haus Juda.",
    translation: "Zürcher Bibel",
  ...
  mutter: {
    ...
    verse:
      "Wie einen, den seine Mutter tröstet, so werde ich euch trösten, und getröstet werdet ihr in Jerusalem.",
    translation: "Zürcher Bibel",
  ...
  retter: {
    ...
    verse:
      "Und Maria sprach: Meine Seele erhebt den Herrn, und mein Geist jubelt über Gott, meinen Retter.",
    translation: "Zürcher Bibel",
  ...
  richter: {
    ...
    verse:
      "Die Himmel sollen seine Gerechtigkeit verkünden, Gott selbst ist Richter.",
    translation: "Zürcher Bibel",
  ...
  schoepfer: {
    ...
    verse:
      "Wohl dem, dessen Hilfe der Gott Jakobs ist, der seine Hoffnung auf den HERRN setzt, seinen Gott, der Himmel und Erde gemacht hat und das Meer und alles, was in ihnen ist, der Treue bewahrt auf ewig.",
    translation: "Zürcher Bibel",
